...
// New создает новый экземпляр типа WebScnr с указанными параметрами
func New(url string, depth int) *WebScnr {
	c := WebScnr{
		URL:   url,
		Depth: depth,
	}
...
func (c *WebScnr) Scan() (data map[string]string, err error) {
